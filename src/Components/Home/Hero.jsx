			...
			<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-center items-end">
				<div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10 pt-35 sm:pt-40 sm:pb-0 lg:pt-35">
					...
					<div className="text-start md:text-left">
						...
						<div className="mt-8">
                            <div>
                                <button className=" flex items-center justify-center gap-2 md:justify-start bg-[#92b115ee] text-white px-6 py-3 rounded-md shadow hover:bg-[#71822bee] transition cursor-pointer"><a href="#contact">
                                    Contact Me
                                </a>
                                <FiSend /> </button>
                            </div>    
