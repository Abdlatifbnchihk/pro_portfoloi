...
function Header() {
  ...
  return (
    <header>
      <div className='fixed top-4 left-1/2 -translate-x-1/2 w-[95%] md:w-[90%] z-50'>
        <div className={`max-w-6xl mx-auto px-3 sm:px-4 lg:px-8 flex justify-between items-center ${isScrolled ? 'shadow-md rounded-2xl bg-white/40 border border-gray-500' : 'bg-transparent'}`}>
        ...
        {/* Mobile Menu */}
        <div
            className={`md:hidden bg-white/60 border border-gray-500 rounded-2xl overflow-hidden transform origin-top transition-all duration-300 absolute top-16 left-0 w-full z-30 ${
              open
