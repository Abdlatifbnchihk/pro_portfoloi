...
function Header() {
  ...
  return (
    <header>
      ...
      {/* Mobile Menu */}
        <div
          className={`md:hidden border-t border-slate-100 bg-green-400 overflow-hidden transform origin-top transition-all duration-300 absolute top-16 left-0 w-full z-30 ${
            open
